...
class MessageCollectionTest extends \Codeception\Test\Unit
{
    ...
    /**
     * @expectedException \Kusabi\Messages\Exceptions\InvalidVerbosityException
     * @expectedExceptionMessage Invalid verbosity level 'not-real'
     */
     ...
     * @expectedExceptionMessage Only message groups can be added to a message collection
     */
    ...
    /**
     * @expectedException \Kusabi\Messages\Exceptions\InvalidVerbosityException
     * @expectedExceptionMessage Invalid verbosity level ''
     */
